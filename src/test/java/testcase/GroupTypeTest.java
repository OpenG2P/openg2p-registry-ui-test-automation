...
public class GroupTypeTest extends BaseLogin {
    ...
    void groupTypeCreation() throws IOException, InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(locators.getProperty("registry_configuration4"))));
        Commons.click(driver, By.xpath(locators.getProperty("registry_configuration4")));
    ...
    void groupTypeDeletion() throws IOException, InterruptedException {
        ...
        By deletedEntry = By.xpath("//tr[td[contains(text(),'" + groupTypeUpdated + "')]]");
